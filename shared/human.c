...
void CreateHuman( Human* human, b3WorldId worldId, b3Vec3 position, float frictionTorque, float hertz,
				  float dampingRatio, int groupIndex, void* userData, bool colorize )
{
...

	{
		...
		bodyDef.position = b3Add( bone->referenceFrame.p, position );
...

	{
		...
		bone->localFrameA =
			( b3Transform ){ { 0.000000, 0.000000, -0.182204 }, { { -0.999999, 0.000000, -0.000000 }, 0.001194 } };
		bone->localFrameB =
			( b3Transform ){ { 0.000000, 0.000000, -0.007736 }, { { -1.000000, 0.000000, -0.000000 }, 0.000000 } };
...

	{
		...
		bone->localFrameB =
			( b3Transform ){ { -0.000000, 0.000000, -0.008199 }, { { -1.000000, 0.000000, -0.000000 }, 0.000000 } };
		bone->swingLimit = 25.0f * B3_DEG_TO_RAD;
		bone->twistLimit = ( b3Vec2 ){ -15.0f * B3_DEG_TO_RAD, 15.0f * B3_DEG_TO_RAD };
	}
...

	{
		...
		bone->jointType = b3_sphericalJoint;
		bone->localFrameA =
			( b3Transform ){ { 0.000001, -0.000259, -0.266585 }, { { -0.942192, -0.000001, 0.000000 }, 0.335074 } };
		bone->localFrameB = ( b3Transform ){ { 0.000000, 0.000000, 0.000000 }, { { -1.000000, 0.000000, -0.000001 }, 0.000000 } };
...

	{
		...
		bone->jointType = b3_sphericalJoint;
		bone->localFrameA =
			( b3Transform ){ { 0.05f, 0.011537f, -0.055325f }, { { -0.714896, -0.022305, -0.698361 }, -0.026790 } };
...

	{
		...
		bone->localFrameA =
			( b3Transform ){ { -0.069989, 0.000253, -0.453844 }, { { -0.000677, 0.760087, 0.105674 }, 0.641171 } };
...

	{
		...
		bone->jointType = b3_revoluteJoint;
		bone->localFrameA =
			( b3Transform ){ { 0.069988, 0.000253, -0.453844 }, { { 0.760086, -0.000675, -0.641171 }, -0.105676 } };
...

	{
		...
		bone->jointType = b3_sphericalJoint;
		bone->localFrameA =
			( b3Transform ){ { 0.203780, -0.069369, -0.181921 }, { { -0.278486, 0.445600, -0.097014 }, 0.845266 } };
...

	{
		...
		bone->jointType = b3_revoluteJoint;
		bone->localFrameA =
			( b3Transform ){ { 0.095484, 0.039585, 0.240723 }, { { -0.180627, 0.512487, -0.003744 }, -0.839474 } };
...
void Human_CreateMotorAnchors( Human* human, b3WorldId worldId )
{
	...
	for ( int i = 0; i < bone_count; ++i )
	{
		...
		b3Transform bodyTransform = b3Body_GetTransform( bone->bodyId );
